...
@interface XLsn0wAnimation () <CAAnimationDelegate>
#else //固件低于iOS 10, 否则就不遵守CAAnimationDelegate协议 无需填写
@interface XLsn0wAnimation ()
#endif
@end

@implementation XLsn0wAnimation

static XLsn0wAnimation *instance = nil;
...
#pragma mark - XLsn0w Animation Methods
